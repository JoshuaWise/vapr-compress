...
The default behavior is to skip responses that have a status code of `300` or higher. If `anyStatus` is `true`, however, responses of any status code will be eligible for compression.
