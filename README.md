...
If the response body is `null` or `undefined`, compression will be skipped. However, empty strings and buffers *are* still considered eligible (for consistency's sake, response size is not take into consideration by default).
