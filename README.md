...
By default, if the client does not provide any content negotiation headers, compression will not be applied. If `aggressive` is `true`, however, compression will be applied in such cases.
